...
export default function NotFound() {
  return (
    <Layout>
      <div className="flex justify-center flex-col items-center py-32 bg-gray-200">
        <h1 className="text-6xl uppercase font-black">404 Not Found</h1>
        <p className="mt-5 text-3xl leading-9 tracking-tight sm
            text-gray-900 dark:text-white">The page you're looking for doesn't exist.</p>
